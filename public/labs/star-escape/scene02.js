...
function puzzle2(){return'<div class="s2-panel s2-q2-panel s2-q2-compact"><div class="s2-q2-compact-head"><small>ANNUAL PARALLAX ANALYZER</small><b>연주시차 분석 장치 암호</b></div><div class="s2-riddle-box"><small>비밀번호 기록이 숨겨진 위치</small><p>나는 문이지만 벽에 서 있지 않는다.<br>열려도 누구도 다음 방으로 가지 않는다.<br>모든 장치가 나를 둘러싸고 있지만,<br>아무도 나를 올려다보지 않는다.<br><b>나는 무엇인가?</b></p></div><label class="s2-password-field"><span>비밀번호</span><input id="s2Password" type="text" maxlength="5" autocomplete="off" autocapitalize="off" spellcheck="false" placeholder="비밀번호 입력"></label></div>'}
