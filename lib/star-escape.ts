...
const QUESTIONS = [
  ...
  [
    { answer: 'A', label: '관측 카드 기준별 선택', hint: '각 요원이 단서 탭에 저장한 3월·9월 카드에서 파란 표적별의 위치 변화를 비교하세요.', hints: ['각 요원이 맡은 별 A~D의 위치 변화가 얼마나 큰지 말로 공유하세요.', '두 카드의 배경별은 같으므로 파란 표적별의 위치만 비교하면 됩니다.', '별 A의 3월·9월 위치 변화가 가장 큽니다.'] },
    { answer: 'ABP', label: '관측 카드와 연주시차', hint: '단서 탭에서 실제로 발견한 3월·9월 카드 두 장을 비교대에 꺼내세요.', hints: ['단서 탭의 3월 18일·9월 18일 카드는 지구가 태양의 반대편에 있을 때의 관측입니다.', '두 겉보기 위치 사이의 전체 각거리는 2p입니다.', '전체 각거리의 절반, 즉 한 관측 위치에서 태양 기준 방향 O까지가 연주시차 p입니다.'] },
