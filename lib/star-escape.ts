...
const QUESTIONS = [
  ...
  [
    ...
    { answer: '6측12', label: '연주시차 분석 장치 암호', hint: '수수께끼가 가리키는 방 안의 장소를 직접 눌러 숨은 정의 기록을 찾으세요.', hints: ['벽이 아니라 발밑을 확인하세요.', '기록은 “별을 (□)개월 간격으로 관(□)했을 때, 두 관측 방향 사이 각의 (□)/(□)이 연주시차이다.”입니다.', '빈칸은 6, 측, 1, 2입니다. 순서대로 이어 입력하세요.'] },
