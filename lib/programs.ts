...
export const programs: Program[] = [
  {
    ...
    url: 'https://rhkdanflab.vercel.app', author: '주인님', featured: true, duration: '20~30분', format: '가상 실험'
  },
  {
    id: 'igneous', title: '화성암 가상실험실',
    summary: '마그마의 냉각 속도에 따른 결정 크기와 화성암 생성 과정을 탐구',
    description: '마그마의 냉각 속도를 조절하고 생성되는 결정의 크기를 비교하며 화성암의 생성 원리를 학습합니다.',
    category: '지질', grade: '중학교', tags: ['화성암','냉각 속도','결정 크기'], icon: '🌋',
    url: 'https://ghktjddka.vercel.app', author: '주인님', featured: true, duration: '20분', format: '시뮬레이션'
  },
  {
    id: 'earth-system-basic', title: '지구계 구성 요소 분류',
    summary: '기권·지권·수권·생물권·외권의 구성 요소를 분류하는 학습 활동',
    description: '다양한 자연 현상과 대상을 지구계의 각 구성 요소로 분류하며 지구계의 구조를 이해합니다.',
    category: '지질', grade: '중학교', tags: ['지구계','기권','지권','수권','생물권'], icon: '🌍',
    url: 'https://wlrnr-pqnsfb.vercel.app', author: '주인님', duration: '15분', format: '분류 활동'
  },
  {
    id: 'earth-system-ai', title: '지구계 탐구 학습 프로그램',
    summary: '지구계 구성 요소와 상호작용을 탐구하고 AI 피드백을 받는 프로그램',
    description: '지구계 구성 요소를 분류하고 상호작용 사례를 탐구한 뒤 AI의 피드백을 받아 학습 내용을 정리합니다.',
    category: '지질', grade: '중학교', tags: ['지구계','상호작용','AI 피드백'], icon: '🌐',
    url: 'https://wlrnr-pqnsfb-ggfy.vercel.app', author: '주인님', featured: true, duration: '30~40분', format: 'AI 탐구'
  },
  {
    id: 'gas-learning-app', title: 'Google Apps Script 학습 프로그램',
    summary: 'Google Apps Script로 제작한 웹 기반 학습 프로그램',
    ...
    author: '주인님', duration: '수업에 따라', format: '웹 프로그램'
  }
];
